...
import { FindPassModal } from "./registration/FindPassModal";
...
export function SiteNav() {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex max-w-7xl w-full items-center justify-between px-5 py-2.5 sm:px-8 sm:py-3">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-1.5 rounded-md border border-slate-200 bg-slate-50 px-3.5 py-2 text-[12.5px] font-bold text-slate-700 transition-colors hover:bg-slate-100 hover:text-nf-blue"
            >
              <Ticket size={13} className="text-nf-blue" />
            ...
            <nav className="flex flex-col gap-1">
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 flex flex-col gap-2.5">
                <button
                  ...
                  onClick={() => {
                    setOpen(false);
                    setFindPassOpen(true);
                  }}
                  className="flex min-h-[44px] items-center justify-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-4 py-2 text-center text-[13.5px] font-bold text-slate-800 transition-all active:scale-[0.98]"
                >
                  <Ticket size={15} className="text-nf-blue" />
                  <span>Find My Pass / Ticket</span>
                </button>
      ...
      {/* Self-service Pass Finder Modal */}
